...
call s:HL('pythonBuiltin', s:blue, '', '')
call s:HL('pythonBuiltinObj', s:orange, '', '')
call s:HL('pythonBuiltinFunc', s:blue, '', '')
call s:HL('pythonFunction', s:blue, '', '')
call s:HL('pythonDecorator', s:green, '', '')
call s:HL('pythonInclude', s:purple, '', '')
call s:HL('pythonImport', s:purple, '', '')
call s:HL('pythonRun', s:blue, '', '')
call s:HL('pythonCoding', s:yellow, '', '')
call s:HL('pythonOperator', s:cyan, '', '')
call s:HL('pythonException', s:red, '', '')
call s:HL('pythonBoolean', s:purple, '', '')
call s:HL('pythonDot', s:gray4, '', '')
call s:HL('pythonConditional', s:purple, '', '')
call s:HL('pythonRepeat', s:red, '', '')
call s:HL('pythonDottedName', s:green, '', '')
